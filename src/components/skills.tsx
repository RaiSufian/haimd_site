    ...
    return (
        <div className="skill_section py-14 bg-black">
            <div className="container mx-auto px-12">
                ...
                <div className="skill_details flex mt-5 flex-wrap">
                    <div className="skill_card p-5 mt-2 lg:w-[33%] md:w-[50%] relative before:absolute before:w-2 before:h-[100%] before:left-0 before:top-0 before:content-[''] before:bg-bg1 before:rounded-lg before:-translate-x-1/2">
                    ...
                    <div className="skill_card p-5 mt-2 lg:w-[33%] md:w-[50%] relative before:absolute before:w-2 before:h-[100%] before:left-0 before:top-0 before:content-[''] before:bg-bg2 before:rounded-lg before:-translate-x-1/2">
                    ...
                    <div className="skill_card p-5 mt-2 lg:w-[33%] md:w-[50%] relative before:absolute before:w-2 before:h-[100%] before:left-0 before:top-0 before:content-[''] before:bg-bg3 before:rounded-lg before:-translate-x-1/2">
